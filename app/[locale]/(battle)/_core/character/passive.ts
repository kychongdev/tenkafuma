...
export function initPassiveSkill(position: number, gameState: GameState) {
  ...
  switch (id) {
      ...
      if (lib === 3) {
        gameState.characters[position].buff = [
          ...
          },
          {
            id: "10004-passive-3",
            name:
              "必殺時，觸發「使敵方全體受到傷害增加12.5%(最多2層)且使敵方全體防禦狀態解除」",
            type: 4,
            condition: Condition.ULTIMATE,
            duration: 100,
            _4: {
    ...
    // "10030": "夏日 露露",
    case "10030": {
      //必殺時，觸發"以自身攻擊力100%對我方全體施放護盾(1回合)"效果
      gameState.characters[position].buff = [
        ...gameState.characters[position].buff,
        {
          id: "10030-passive-1",
          name: '每經過4回合，觸發"使目標受到傷害增加35%(1回合)"效果',
          duration: 100,
      ...
      if (stars === 5) {
        gameState.characters[position].buff = [
          ...gameState.characters[position].buff,
          {
            id: "10030-passive-2",
            name:
              '第1回合時，觸發"使我方治療者與輔助者必殺技傷害增加40%(50回合)"效果',
            duration: 100,
            condition: Condition.ON_TURN_START,
            type: 21,
            _21: {
              trigger: [{
                id: "10030-passive-2-1",
                name:
                  '第1回合時，觸發"使我方治療者必殺技傷害增加40%(50回合)"效果',
                duration: 100,
                condition: Condition.NONE,
                type: 11,
                _11: {
                ...
                id: "10030-passive-2-2",
                name:
                  '第1回合時，觸發"使我方輔助者必殺技傷害增加40%(50回合)"效果',
                duration: 100,
                condition: Condition.NONE,
                type: 11,
                _11: {
    ...
    case "10057": {
      ...
      gameState.characters[position].buff = [
        ...
        },
        {
          id: "10057-passive-2",
          name:
            "第1回合開始時，發動「使我方站位2、4的隊員受到傷害減少15%(50回合)」效果",
          type: 21,
          condition: Condition.ON_TURN_START,
          duration: 100,
          _21: {
        ...
        },
        {
          id: "10057-passive-3",
          name:
            "每經過6回合，觸發「使我方站位1、3、5的隊員必殺技傷害增加50%(2回合)」效果",
          type: 11,
          condition: Condition.EVERY_X_TURN,
          conditionTurn: 6,
          duration: 100,
    ...
    case "10072": {
      gameState.characters[position].buff = [
...

        {
          ...
          _4: {
            increaseStack: 1,
            targetSkill: "10072-passive-4-1",
            target: Target.SELF,
            applySkill: {
              id: "10072-passive-4-1",
              name: "攻擊力增加",
              type: 3,
              condition: Condition.NONE,
              duration: 100,
    ...
    case "10078": {
      gameState.characters[position].buff = [
        ...gameState.characters[position].buff,
        {
          ...
          _4: {
            increaseStack: 1,
            targetSkill: "10078-passive-1-1",
            target: Target.SELF,
            applySkill: {
              id: "10078-passive-1-1",
              name: "攻擊力增加",
              type: 3,
              condition: Condition.NONE,
              duration: 100,
      ...
      if (gameState.characters[position].stars === 5) {
        gameState.characters[position].buff = [
          ...gameState.characters[position].buff,
          {
            ...
            _4: {
              increaseStack: 1,
              targetSkill: "10078-passive-4-1",
              target: Target.ENEMY,
              applySkill: {
                id: "10078-passive-4-1",
                name: "受到水屬性傷害增加",
                type: 3,
                condition: Condition.NONE,
                duration: 100,
          ...
          },
          {
            ...
            _4: {
              increaseStack: 1,
              targetSkill: "10078-passive-5-1",
              target: Target.ENEMY,
              applySkill: {
                id: "10078-passive-5-1",
                name: "受到普攻傷害增加",
                type: 3,
                condition: Condition.NONE,
                duration: 100,
      ...
      if (lib === 1 || lib === 2) {
        gameState.characters[position].buff = [
          ...
          },
          {
            id: "10081-passive-2",
            name:
              "每經過1回合，觸發「使自身與我方全體水屬性角色必殺技傷害增加9%(最多11層)」",
            type: 4,
            condition: Condition.EVERY_X_TURN,
            conditionTurn: 1,
            duration: 100,
    ...
    case "10088": {
      gameState.characters[position].buff = [
        ...
        },
        {
          id: "10088-passive-2",
          name:
            "使我方全體攻擊者獲得「必殺時，觸發『以攻擊力77%對目標造成傷害』(1回合)」",
          type: 11,
          condition: Condition.ULTIMATE,
          duration: 100,
          _11: {
        ...
        },
        {
          id: "10088-passive-3",
          name:
            "使我方全體妨礙者獲得「必殺時，觸發『以攻擊力77%對目標造成傷害』(1回合)」",
          type: 11,
          condition: Condition.ULTIMATE,
          duration: 100,
          _11: {
            ...
            applySkill: [
              {
                ...
                name:
                  "必殺時,觸發 以自身攻擊力25%使我方攻擊者攻擊力增加(1回合)",
                type: 6,
                condition: Condition.ULTIMATE,
                duration: 1,
                _6: {
      ...
      if (charIndex2 !== -1) {
        gameState.characters[charIndex2].buff = [
          ...gameState.characters[charIndex2].buff,
          {
            id: "10135-passive-2",
            name:
              "攻擊時，觸發「以自身攻擊力10%使【偶像經紀人 梅絲米奈雅】攻擊力增加(1回合)」",
            type: 6,
            condition: Condition.ATTACK,
            duration: 100,
            _6: {
      ...
      if (gameState.characters[position].stars === 5) {
        ...
        gameState.characters[charIndex4].buff = [
          ...gameState.characters[charIndex4].buff,
          {
            id: "10135-passive-9",
            name:
              "必殺時，觸發「使【偶像經紀人 梅絲米奈雅】獲得造成傷害增加40%(2回合)」",
            type: 11,
            condition: Condition.ULTIMATE,
            duration: 100,
            _11: {
    ...
    case "10140": {
      ...
      if (gameState.characters[position].stars === 5) {
        gameState.characters[position].buff = [
          ...
          {
            id: "10140-passive-6",
            name: "普攻時，觸發「使目標獲得3層受到傷害增加5%(最多9層)」",
            type: 4,
            condition: Condition.BASIC_ATTACK,
            duration: 100,
            disableOnStack: true,
      ...
      gameState.characters.forEach((_, index) => {
        gameState.characters[index].buff = [
          ...
          },
          {
            id: "10152-passive-3",
            name:
              "防禦時，觸發「使我方『治癒之星 蘇珊』造成治療增加10%(2回合)」",
            type: 13,
            condition: Condition.GUARD,
            duration: 100,
            _13: {
    ...
    case "10153": {
      gameState.characters[position].buff = [
        ...gameState.characters[position].buff,
        {
          id: "10153-passive-1",
          name:
            "必殺時，觸發「使自身不受《向聖杯祈願》層數變動效果影響(50回合)」(觸發1次後解除)",
          type: 11,
          condition: Condition.ULTIMATE,
          duration: 100,
          deleteSelf: true,
        ...
        if (index !== position) {
          gameState.characters[index].buff = [
            ...gameState.characters[index].buff,
            {
              id: "10153-passive-3",
              name:
                "被攻擊時，觸發「使我方【純真殺意 撒旦】獲得1層《高級萬聖甜點組》(最多6層)」",
              type: 4,
              condition: Condition.RECEIVED_ATTACK,
              duration: 100,
              _4: {
    ...
    case "10154": {
      gameState.characters[position].buff = [
        ...gameState.characters[position].buff,
        {
          id: "10154-passive-1",
          name:
            "必殺時，觸發「使自身不受《戀愛的萌系能量》層數變動效果影響(50回合)」(觸發1次後清除)",
          type: 11,
          condition: Condition.ULTIMATE,
          duration: 100,
          deleteSelf: true,
                  ...
                  applySkill: [
                    {
                      ...
                      name:
                        "「防禦時，觸發『使自身當前必殺技CD增加3回合，並使自身獲得嘲諷效果(1回合)』」",
                      type: 2,
                      condition: Condition.GUARD,
                      duration: 100,
                      _2: {
                  ...
                  applySkill: [
                    {
                      ...
                      name:
                        "「防禦時，根據自身《戀愛的萌系能量》的層數，觸發『《萌耶～萌耶～碰碰碰～♪》』(1回合)」",
                      type: 8,
                      condition: Condition.GUARD,
                      duration: 100,
                      _8: {
      ...
      if (stars === 5) {
        gameState.characters[position].buff = [
          ...gameState.characters[position].buff,
          {
            id: "10157-passive-7",
            name:
              "攻擊時，根據自身《純真祈願》的層數，觸發「使目標受到傷害增加0.25%(最多80層)」",
            type: 8,
            condition: Condition.ATTACK,
            duration: 100,
            _8: {
          ...
          },
          {
            id: "10157-passive-8",
            name:
              "攻擊時，根據自身《純真祈願》的層數，觸發「使目標受到水屬性傷害增加0.25%(最多80層)」",
            type: 8,
            condition: Condition.ATTACK,
            duration: 100,
            _8: {
          ...
          },
          {
            id: "10157-passive-9",
            name:
              "攻擊時，根據自身《純真祈願》的層數，觸發「使目標受到火屬性傷害增加0.25%(最多80層)」",
            type: 8,
            condition: Condition.ATTACK,
            duration: 100,
            _8: {
          ...
          },
          {
            id: "10157-passive-10",
            name:
              "攻擊時，根據自身《純真祈願》的層數，觸發「使目標受到風屬性傷害增加0.25%(最多80層)」",
            type: 8,
            condition: Condition.ATTACK,
            duration: 100,
            _8: {
          ...
          },
          {
            id: "10157-passive-12",
            name:
              "攻擊時，根據自身《純真祈願》的層數，觸發「使目標受到暗屬性傷害增加0.25%(最多80層)」",
            type: 8,
            condition: Condition.ATTACK,
            duration: 100,
            _8: {
    ...
    case "10163": {
        ...
        },
        {
          ...
          _8: {
            ...
            triggerSkill: {
              ...
              name:
                "根據自身《魔分身》層數觸發「以自身攻擊力90%對目標造成傷害」",
              type: 1,
              condition: Condition.NONE,
              duration: 100,
              _1: {
      ...
      //我方全體攻擊者、妨礙者獲得，第一回合時，觸發「使我方『夜之影 凱薩』攻擊力增加50%(最多3層)」
      gameState.characters.forEach((character, index) => {
        if (
          character.class === CharacterClass.ATTACKER ||
          character.class === CharacterClass.OBSTRUCTER
          ...
          gameState.characters[index].buff = [
            ...gameState.characters[index].buff,
            {
              id: "10163-passive-5",
              name:
                "第一回合時，觸發「使我方『夜之影 凱薩』攻擊力增加50%(最多3層)」",
              type: 4,
              condition: Condition.ON_TURN_START,
              duration: 100,
              _4: {
